...
//   text,          menu ID
    ...
    {"Rx CTC",      MENU_R_CTCS        }, // was "R_CTCS"
    {"Tx DCS",      MENU_T_DCS         }, // was "T_DCS"
    {"Tx CTC",      MENU_T_CTCS        }, // was "T_CTCS"
    {"RloYon",      MENU_SFT_D         }, // was "SFT_D"
    {"RloOfs",      MENU_OFFSET        }, // was "OFFSET"
    {"W/N",         MENU_W_N           },
#ifndef ENABLE_FEAT_F4HWN
    {"Scramb",      MENU_SCR           }, // was "SCR"
#endif
    {"DolKlt",      MENU_BCL           }, // was "BCL"
    {"Kompnd",      MENU_COMPAND       },
    {"Mod",         MENU_AM            }, // was "AM"
#ifdef ENABLE_FEAT_F4HWN
    {"TxKlit",      MENU_TX_LOCK       }, 
    ...
    {"TarEk2",      MENU_S_ADD2        },
    {"TarEk3",      MENU_S_ADD3        },
    {"KnlKay",      MENU_MEM_CH        }, // was "MEM-CH"
    {"KnlSil",      MENU_DEL_CH        }, // was "DEL-CH"
    {"KnlIsm",      MENU_MEM_NAME      },
    ...
    {"TusKlt",      MENU_AUTOLK        }, // was "AUTOLk"
    {"TxSure",      MENU_TOT           }, // was "TOT"
    {"PilTsr",      MENU_SAVE          }, // was "SAVE"
    {"PilGst",      MENU_BAT_TXT       },
    {"Mik",         MENU_MIC           },
    {"MikCub",      MENU_MIC_BAR       },
    {"KnlGst",      MENU_MDF           }, // was "MDF"
    {"AclMsg",      MENU_PONMSG        },
    {"IsikSr",      MENU_ABR           }, // was "ABR"
    {"IsikMn",      MENU_ABR_MIN       },
    {"IsikMx",      MENU_ABR_MAX       },
    {"IsikTR",      MENU_ABR_ON_TX_RX  },
    {"Bip",         MENU_BEEP          },
#ifdef ENABLE_VOICE
    {"SesReh",      MENU_VOICE         },
#endif
    ...
    {"D List",      MENU_D_LIST        },
#endif
    {"D Canl",      MENU_D_LIVE_DEC    }, // live DTMF decoder
#ifndef ENABLE_FEAT_F4HWN
    #ifdef ENABLE_AM_FIX
        {"AM Fix",      MENU_AM_FIX        },
    #endif
...
#ifndef ENABLE_FEAT_F4HWN
    {"ScraAc",      MENU_SCREN         }, // was "SCREN"
#endif
#ifdef ENABLE_F_CAL_MENU
    {"FrKal",       MENU_F_CALI        }, // reference xtal calibration
#endif
...
#endif
    {"TUS\nKILIDI",     ACTION_OPT_KEYLOCK},
    {"VFO A\nVFO B",    ACTION_OPT_A_B},
    {"VFO\nHAFIZA",     ACTION_OPT_VFO_MR},
    {"MOD",             ACTION_OPT_SWITCH_DEMODUL},
#ifdef ENABLE_BLMIN_TMP_OFF
    {"ISIK\nKAPAT",     ACTION_OPT_BLMIN_TMP_OFF},      //BackLight Minimum Temporay OFF
#endif
#ifdef ENABLE_FEAT_F4HWN
    {"RX MODU",         ACTION_OPT_RXMODE},
    {"ANA SDC",         ACTION_OPT_MAINONLY},
    {"PTT",             ACTION_OPT_PTT},
    {"GENIS\nDAR",      ACTION_OPT_WN},
